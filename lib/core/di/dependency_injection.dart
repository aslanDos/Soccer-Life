...
Future<void> init() async {
  ...
  di.registerLazySingleton<GetFixturesUsecase>(
    () => GetFixturesUsecase(di<LeagueRepository>()),
  );
  di.registerFactory<FixturesProvider>(
    () => FixturesProvider(di<GetFixturesUsecase>()),
  );
